...
// Install block
	...
	'PRIVATE_PGP_KEY_FILE'		=> 'Файл с закрытым ключём PGP',
	'PGP_KEY_USER_ID'		=> 'ID пользователя ключа',
	'PGP_PASSPHRASE'		=> 'Парольная фраза',
	'PGP_DECRYPTION_NOTICE'	=> 'Это сообщение было зашифровано ключом PGP {1}. Чтобы расшифровать его, предоставь закрытый ключ (файл или текст) и введи парольную фразу. Расшифровка проходит в браузере.',
